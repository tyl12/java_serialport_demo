 ...
 */
public class Example implements com.xiaomeng.rxtx.Network_iface {

	// set the speed of the serial port
	public static int speed = 9600;
	private static com.xiaomeng.rxtx.Network network;

	private static boolean resend_active = false;

	public static void main(String[] args) {
		network = new com.xiaomeng.rxtx.Network(0, new com.xiaomeng.rxtx.Example(), 255);
